      ...
      <section id={id} className="bg-gray-100 min-h-screen relative">
        <div className="flex flex-row w-full h-full">
          <div className="relative w-1/2">
            ...
            <div>
              <img
                className="z-11 hover:brightness-95 transition-all duration-300 -left-60 top-[22%] scale-[0.55] hover:scale-60 absolute rounded-full"
                src="src/assets/imgs/theo.jpeg"></img>
            </div>
          </div>

          <div className="flexivel w-1/2 flex flex-col justify-center text-right">
            <div className="leading-40 text-[12rem] hover:scale-105 hover:brightness-95 transition-all duration-300 text-shadow-lg">
              <h1 className=" text-(--melon)">
                Who <br />
                <span className="text-(--indigo-dye)">Am</span> <br />I
              </h1>
            </div>
            <div className="text-[1.2rem] leading-10 hover:scale-105 hover:brightness-95 transition-all duration-300">
