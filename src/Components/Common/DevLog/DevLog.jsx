...
export default function DevLog({ id }) {
  return (
    <section id={id} className="bg-gray-100 w-full relative">
      <MediaQuery minWidth = {1920}>
        <div onMouseOver = {startAnimation} className="flex flex-row w-full h-full">
          <div className="relative w-1/2">
            ...
            <div>
              <img
                className="z-11 w-48 h-48 hover:brightness-95 transition-all -left-3 duration-300 top-[41%] scale-[1.8] absolute rounded-full"
                src={gameImage}></img>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center video-title">
            ...
            <div className="flex video title">
              <a
      ...
      <MediaQuery minWidth={1280} maxWidth = {1500}>
        <div
          ...
          <div className="flexivel w-1/2 flex flex-col items-center justify-center">
            <div className="leading-40 text-[12rem] hover:scale-101 hover:brightness-95 transition-all duration-300 text-shadow-lg text-right">
              <h1 className="text-[var(--melon)]">
                Dev<span className="text-[var(--indigo-dye)]">Log</span> <br />
              </h1>
            </div>
            <div className="flex video title justify-center">
              <a
                href="https://www.youtube.com/watch?v=-Bs6EO_Co7Q"
                target="_blank"
                rel="noopener noreferrer">
